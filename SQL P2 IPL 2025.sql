...
# CREATE TABLE IPLPlayers (
    Player VARCHAR(120) CHARACTER SET utf8mb4,
    Price_in_cr DECIMAL(10, 2),
    Type VARCHAR(50) CHARACTER SET utf8mb4,
    Acquisition VARCHAR(50) CHARACTER SET utf8mb4,
    Role VARCHAR(50) CHARACTER SET utf8mb4,
    Team VARCHAR(100) CHARACTER SET utf8mb4
);
...
QUESTIONS :-
# Q1. Find the total spendingon players for each team.
...
# Q3. Find the highest-priced playern in each team:
...
FROM IPLPlayers i
JOIN CTE_HP hp ON i.Team = hp.Team AND i.Price_in_cr = hp.MaxPrice
ORDER BY i.Price_in_cr DESC;
...
Low: Price < ₹5 crore  and Find out the number of players in each bracket for every team.
...
# Q9. Idntify players who earn more than the average price in their team.
...
WHERE Price_in_cr > (
    ...
    FROM IPLPlayers AS team_avg
    WHERE team_avg.Team = IPLPlayers.Team
);
